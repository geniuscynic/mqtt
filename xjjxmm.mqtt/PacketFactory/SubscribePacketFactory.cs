...
internal class SubscribePacketFactory : IPacketFactory
{
    private readonly SubscribePacket packet;
    public SubscribePacketFactory(SubscribeOption option)
    {
    ...
    public SubscribePacketFactory(ReceivedPacket received)
    {
